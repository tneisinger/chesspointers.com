    ...
    <Card>
      ...
      <CardContent>
        <Typography>
          ...
          - Client and server are in watch mode with source maps, opens{' '}
        ...
        <Typography>
          <strong>npm start:prod</strong> - sets <strong>NODE_ENV </strong>
          to <strong>production</strong> and then runs
